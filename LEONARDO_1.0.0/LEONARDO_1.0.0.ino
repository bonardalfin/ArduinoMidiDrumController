...
// Pad langsung           12                Pin A0–A10 Leonardo
// Total Pad              12                MIDI channel 10 (default drum)
...
// === Konfigurasi ===
const byte numDirectPads = 12;  // Jumlah Pad yang Direct ke Arduino
const byte piezoDirectPins[numDirectPads] = {A0, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11};
...
byte midiNotes[numDirectPads] = {
  36, 38, 40, 41, 43, 45, 47, 48, 50, 51, 60, 46
};
...
void initPadConfigs() {
  ...
  padConfigs[10] = {20, 500, 15, 127, 0, 50}; // Bebas buat apaan
  padConfigs[11] = {20, 500, 15, 127, 0, 50}; // Hi-hat (switched open/closed)
}
