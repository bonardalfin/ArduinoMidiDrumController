...
// Pad langsung           12                Pin A0–10 Leonardo
...
const byte piezoDirectPins[numDirectPads] = {A0, A1, A2, A3, A4, A5, 4, 6, 7, 8, 9, 10  // Tidak perlu diubah
  };
...
const byte hiHatPadIndex = 11; // pad direct terakhir - Pin A13 pada Arduino
